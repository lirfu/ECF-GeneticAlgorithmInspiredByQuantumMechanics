#ifndef NNERROREVALOP_H_
#define NNERROREVALOP_H_
 ...
 */
class NNErrorEvalOp : public EvaluateOp {
protected:
public:
...
typedef boost::shared_ptr<NNErrorEvalOp> NNErrorEvalOpP;

#endif /* NNERROREVALOP_H_ */
